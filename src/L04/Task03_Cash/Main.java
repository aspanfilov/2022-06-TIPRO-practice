...
public class Main {
    ...
    private static final int MAX_CASH_QUEUE_SIZE = 10;
    ...
    public static void main(String[] args) {
        ...
        var cashes = cashGenerator.getCashes(CASH_COUNT, MAX_CASH_SPEED, MAX_CASH_QUEUE_SIZE, MAX_CASH_DEFAULT_QUEUE_SIZE);
